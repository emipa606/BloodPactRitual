...
namespace Blood_Pact_Ritual.BloodPactRitual
{
    ...
    public class PactShieldBubble
    {
        ...
        private static readonly Material BubbleMat = MaterialPool.MatFrom("Other/BloodPactShield", ShaderDatabase.Transparent, FullColor);
        private static readonly Material ArrowMat = MaterialPool.MatFrom("Other/BloodPactSource", ShaderDatabase.Transparent, FullColor);

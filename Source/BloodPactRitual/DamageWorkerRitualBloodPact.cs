...
namespace Blood_Pact_Ritual.BloodPactRitual
{
    public class DamageWorkerRitualBloodPact : DamageWorker
    {
        ...
        private static DamageResult ApplyPactDamage(DamageInfo dinfo, Thing thing)
        {
            ...
            var cutSelf = new DamageInfo(BloodPactDamageDefOf.RitualBloodPactSymbolicInjury, PactDamage, -1, 0, thing, null,
                dinfo.Weapon, dinfo.Category);
            var cutSelfInstigator = new DamageInfo(BloodPactDamageDefOf.RitualBloodPactSymbolicInjury, PactDamage, -1, 0, dinfo.Instigator,

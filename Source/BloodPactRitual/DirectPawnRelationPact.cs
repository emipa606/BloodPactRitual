...
namespace Blood_Pact_Ritual.BloodPactRitual
{
    internal class DirectPawnRelationPact : DirectPawnRelation
    {
        ...
        public DirectPawnRelationPact(PawnRelationDef def, Pawn otherPawn, int startTicks) : base(def, otherPawn, startTicks)
        {
        }

        public DirectPawnRelationPact(DirectPawnRelation existing) : this(existing.def, existing.otherPawn, existing.startTicks)
        {            
        }
        ...
        public static Pawn GetPactPawn(Pawn pawn)
        {
            ...
            return pactRelation == null ? null : pactRelation.otherPawn;
        }
        ...
        public static DirectPawnRelationPact GetPactRelation(Pawn pawn)
        {
            ...
            var relation = pawn.relations.DirectRelations.Find(x => x.def == BloodPactPawnRelationDefOf.PawnRelationBloodPact);
            if (relation == null)
                return null;
            
            var res = relation as DirectPawnRelationPact;
            if (res != null)
                return res;
        ...
        public static void CheckExistingPactValidity(Pawn pawn)
        {
            ...
            var first = true;
            foreach(var relation in pawn.relations.DirectRelations.FindAll(x => x.def == BloodPactPawnRelationDefOf.PawnRelationBloodPact))
            {                
        ...
        private static bool IsValid(DirectPawnRelation relation, Pawn pawn)
        {
            ...
            if (otherPawn == null || otherPawn.Faction == null || !otherPawn.Faction.IsPlayer || otherPawn.relations == null)
                return false;
